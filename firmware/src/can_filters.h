...
const uint8_t can_filter[] PROGMEM =
{
    ...
    // Group 1
    MCP2515_FILTER(CAN_FILTER_MSG_MIC17_PUMPS), // Filter 2
    MCP2515_FILTER(CAN_FILTER_MSG_MIC17_PUMPS), // Filter 3
    MCP2515_FILTER(CAN_FILTER_MSG_MIC17_PUMPS), // Filter 4
    MCP2515_FILTER(CAN_FILTER_MSG_MIC17_PUMPS), // Filter 5
